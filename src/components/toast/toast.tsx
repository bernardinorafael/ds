    ...
    variants: {
      intent: {
        action: [
          "bg-[#32B34E]",
          "text-white",
          "not-disabled:hover:bg-[#2da046]",
          "[--focus-ring-color:rgb(50_179_78/0.2)]",
          "[--focus-offset-color:#32B34E]",
        ],
        destructive: [
          "bg-[#D54347]",
          "text-white",
          "not-disabled:hover:bg-[#c03c40]",
          "[--focus-ring-color:rgb(213_67_71/0.2)]",
          "[--focus-offset-color:#D54347]",
        ],
        cancel: [
          "bg-white/15",
          "text-white/80",
...
function ToastButton({
  ...
  intent: "action" | "destructive" | "cancel"
  disabled?: boolean
  form?: string
}) {
  return (
            ...
            <div className="ml-auto flex items-center gap-1.5 whitespace-nowrap">
              ...
              {t.action && (
                <ToastPrimitive.Action altText={t.action.label} asChild>
                  <ToastButton
                    intent={t.intent === "error" ? "destructive" : "action"}
