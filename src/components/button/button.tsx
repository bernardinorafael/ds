  ...
  ],
  {
    variants: {
      intent: {
        ...
        link: [
          "text-primary",
          "not-disabled:hover:text-primary/80",
          "[--focus-ring-color:color-mix(in_srgb,var(--color-primary)_20%,transparent)]",
          "[--focus-offset-color:var(--color-primary)]",
        ],
        "link-underline": [
          ...
          "not-disabled:hover:text-foreground/80",
          "not-disabled:hover:decoration-foreground/60",
          "[--focus-ring-color:color-mix(in_srgb,black_13%,transparent)]",
          "[--focus-offset-color:color-mix(in_srgb,black_15%,transparent)]",
        ],
      },
    ...
    compoundVariants: [
      { intent: "link", size: "sm", className: "h-auto rounded-none px-0" },
      { intent: "link", size: "md", className: "h-auto rounded-none px-0" },
      { intent: "link-underline", size: "sm", className: "h-auto rounded-none px-0" },
      { intent: "link-underline", size: "md", className: "h-auto rounded-none px-0" },
    ],
    defaultVariants: {
      intent: "primary",
      size: "md",
